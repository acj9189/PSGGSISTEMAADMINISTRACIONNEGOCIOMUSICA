...
var fecha=dia+'/'+m+'/'+ano;
	...
	$.post("../controladora/controladora.php",{nombre:nombre,telefono:telefono,articulo:articulo,modelo:modelo,marca:marca,serie:serie,problemareportado:problemareportado,notas:notas,fecha:fecha,funcion:3},function(respuesta)
	{
