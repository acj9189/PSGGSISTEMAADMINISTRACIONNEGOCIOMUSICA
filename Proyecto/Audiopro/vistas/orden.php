...
<div id="wrapper">
    ...
    <ul class="menu">
        <li class="item1"><a href="#">Entrada - Artículo </a>
            <ul>
                <li class="subitem1"><a  href="../vistas/orden.php" >Registrar Entrada</a></li>
                  <li class="subitem1"><a href="../vistas/ordenConsulta.php" >Consultar Registro</a></li>
        ...
        <li class="item1"><a href="#">Diagnóstico</a>
            <ul>
            	<li class="subitem1"><a  href="../vistas/diagnosticar.php">Diagnosticar Entradas</a></li>
...
<div class="col-xs-6">
<h6>Activo Fijo:</h6>
<input type="text" id="activofijo" name="activofijo" value="NA">
</div>
<div class="col-xs-6">
<h6>OT:</h6>
<input type="text" id="ot" name="ot" value="NA">
</div>
<div class="col-xs-12">
<h6>Problema Reportado:</h6>
<textarea type="text" id="reporte" name="reporte" style="width:900px; height:80px"></textarea>
</div>
<div class="col-xs-6">
<h6>Notas:</h6>
<textarea type="text" id="notas" name="notas" style="width:900px; height:40px"></textarea>
</div>
</div>
